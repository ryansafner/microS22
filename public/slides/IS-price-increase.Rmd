...
opt_inf<-ggplot(data = tibble(x = c(0,10)), aes(x = x))+
  ...
  geom_function(fun = ic_inf, geom = "line", size = 2, color = "green", xlim=c(8,20))+
  geom_label(x = 22, y = ic_inf(22), color = "green", label = expression(u[2]))+
...
se_dom_inf<-ggplot(data = tibble(x = c(0,10)), aes(x = x))+
  ...
  geom_function(fun = ic_inf, geom = "line", size = 2, color = "darkblue")+
...
```{r, fig.retina=3, fig.height=6}
se_dom_inf+
  annotate("segment", x = 9, xend = 10, y = 6, yend = 6, colour = "green", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))
```
