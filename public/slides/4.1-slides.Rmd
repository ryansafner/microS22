...
- With a monopoly, we can safely ignore the effects that *other* sellers have on the firm’s behavior
  - An easy starting point, for now
  - Later, will need game theory
]
]
.pull-right[
.center[
