...
### [The *Ugly* of Market Power: Rent-Seeking](#53)
...
$$C(q)=cq$$
  - No fixed costs
  - implies $\color{red}{MC(q)}=\color{orange}{AC(q)}$
  - Why? [See here](/content/2.5-content/#common-cost-assumptions)

- If this industry were **competitive**, firms would set $p_c=MC(q)$ and (collectively), industry would produce $q_c$
...
ggplot(data.frame(x=c(0,10)), aes(x=x))+
  ...
  # surpluses
  geom_rect(xmin=3,xmax=4,ymin=2,ymax=6,fill="black", alpha=0.3)+ #profit
  geom_polygon(data=dwl_x2, aes(x=x,y=y), fill="black",alpha=0.5)+ #dwl
  ...
  annotate("segment", x = 1, xend = 1, y = 2, yend = 4, colour = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))+
  annotate("segment", x = 1, xend = 1, y = 6, yend = 7, colour = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))+
  annotate("segment", x = 4, xend = 3, y = 1, yend = 1, colour = "black", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))+
  guides(fill=F)+
  labs(x = "Quantity",
       y = "Price")+
  theme_classic(base_family = "Fira Sans Condensed", base_size=16)
...
- Aside: courts in antitrust cases often also focus on the .hi-purple[cross-price elasticities] between goods!
...
.pull-left[
.center[
![:scale 50%](../images/debeers.png)

![:scale 50%](../images/debeersdiamonds.jpg)
]
]

.pull-right[
.center[
![:scale 50%](../images/alcoa.png)

![:scale 50%](../images/alcoa2.jpg)
]
]
...
.pull-left[
.center[
![:scale 100%](../images/peopleliketechcompanies.jpg)
]
]
...
.center[
![](../images/pew_2020_people_like_tech.jpg)
]
]
...
We tackle these questions more in my Industrial Organization course:
...
.pull-left[
.center[
![:scale 80%](../images/aetnamerger2.png)
