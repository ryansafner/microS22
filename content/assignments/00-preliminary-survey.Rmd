...
{{% alert note %}}
Please submit by 11:59 PM Sunday January 30, 2022
{{% /alert %}}
...
<p style="text-align:center"><a target="_blank" href="/assignment/00-preliminary-survey-pdf.pdf"><span class="btn btn-primary btn-lg"><i class="fas fa-file-pdf"></i> Download PDF</a></span> <p style="text-align:center"><a target="_blank" href="/assignment/00-preliminary-survey-answers.html"><span class="btn btn-primary btn-lg"><i class="far fa-life-ring"></i> Answer Key</a></span></p>
