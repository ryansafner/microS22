...
{{% alert warning %}}
[Problem Set 2](/assignments/02-problem-set) is due by next Monday September 20.
{{% /alert %}}
...
[Problem set 2](/assignments/02-problem-set) (on classes 1.6-1.8) is due by Monday, September 20 by PDF upload to Blackboard Assignments.
