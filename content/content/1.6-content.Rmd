...
{{% alert warning %}}
[Problem Set 1](/assignments/01-problem-set) is due by class today. [Problem Set 2](/assignments/02-problem-set) is now posted, and is due by class next Monday February 21.
{{% /alert %}}
...
[Problem set 1](/assignments/01-problem-set) **is due** by PDF upload to Blackboard Assignments.

## Problem Set 2 Due Mon Sep 20

[Problem set 2](/assignments/02-problem-set) (on classes 1.6-1.8) is due by class time on Monday, September 20 by PDF upload to Blackboard Assignments.
...
demands <- ggplot(data = tibble(x = c(0,10)), aes(x = x))+
  stat_function(fun = h_d, geom = "line", size = 2, color = "red")+
  stat_function(fun = m_d, geom = "line", size = 2, color = "blue")+
  annotate(geom = "label", x = 3, y = h_d(3), color = "red", label = "Hicksian Demand", size = 4)+
  annotate(geom = "label", x = 3, y = m_d(3), color = "blue", label = "Marshallian Demand", size = 4)+
