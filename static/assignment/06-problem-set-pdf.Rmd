...
10. Consider a boat rental firm on a popular beach that has a constant average and marginal cost of $30 per boat hire. It has estimated that demand from Locals $(L)$ and demand from Tourists $(T)$ are:
$$\begin{aligned}
q_L&=40-0.4p\\
q_T&=25-0.1p\\
\end{aligned}$$
...
11. Malwart is a large retail chain that has opened in a small town. With few other job opportunities for low-skilled workers, it has monopsony power in the local labor market for low-skilled workers. Its marginal revenue product of labor is
$$MRP_L=80-0.8L$$
where $L$ is the total number of workers. The labor supply curve of local low-skilled workers is
$$w=0.4L+8$$

where $w$ is the yearly wage (in $1,000’s per worker).

a. Write a function for the marginal cost of labor.
b. What quantity of workers will the firm hire, and what wage will it pay its workers?
c. What would the quantity of workers be, and what would the wage be, if the labor market was perfectly competitive?
d. Calculate the price elasticity of labor supply at the monoposony wage from part C.
e. Now suppose a new commuter rail service allows workers to cheaply commute to nearby towns to work, making the labor supply curve instead:
$$w=0.4L+8$$
What quantity of workers will the firm hire, and what wage will it pay its workers?^[Hint: first find the new $MC(L)$ equation.]
f. Calculate the price elasticity of labor supply at the monoposony wage from Part E.
g. Compare your answers to Parts C & D to Parts E & F. How is market power (and inefficiency) related to price elasticity?