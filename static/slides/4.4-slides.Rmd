...
output:
  xaringan::moon_reader:
    #mathjax: "https://cdn.bootcss.com/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_HTMLorMML" # rescales math with css changes https://github.com/yihui/xaringan/issues/143    lib_dir: libs
    lib_dir: libs
    #seal: false
...
ggplot(data.frame(x=c(0,12)), aes(x=x))+
  stat_function(fun=Demand_total, geom="line", color="darkblue", size=2)+
  ...
  annotate("segment", x = 75, xend = 15, y = 20, yend = 20, colour = "purple", size=2, alpha=1, arrow=arrow(length=unit(0.5,"cm"), ends="last", type="closed"))+
  geom_label(x=50,y=20, color = "purple", label="Demand for all \n other firms' products")+
  labs(x = "Quantity (q)",
       y = "Price (p)",
       title = "Total Market")+
...
- .hi-purple[Long run equilibrium]: firms earn $\color{green}{\pi=0}$ where $\color{blue}{p}=\color{orange}{AC(q)}$<sup>.magenta[†]</sup>
...
<sup>.magenta[‡]</sup> A cartel is $n$ firms that *act* as a single monopolist, but each gets (for simplicity)  $\frac{1}{n}$ of the total profits.]
